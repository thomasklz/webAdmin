                ...
                <div class="container">
                    ...
                    <div class="row">
                                    ...
                                    <div id="tab_1" class="tab-pane active">
                                        ...
                                        <div class="row tab-post"><!-- post -->
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                                <a href="blog-sidebar-left.html" class="tab-post-link">{!! str_limit("$noticia->titulo",35) !!}</a>
                        ...
                        <div class="col-md-9 col-sm-9">
                            @php($a=0)
                            @foreach($noticiasActual as $noticiaActual)
                            ...
                            <ul class="blog-post-info list-inline">
                                <li>
                                    <a href="#">
                                        ...
                                        <span class="font-lato">{{$noticiaActual->fechaPublicacion}}</span>
                                    </a>
                                </li>
                           ...
                           <div class="nivoSlider" data-controlNav="true" data-pauseOnHover="false" style="width: 830px; height: 350px">
                                @foreach($noticiasActual as $noticiaActuals)
                                    <img src='{{asset("img/noticia/$noticiaActuals->foto")}}' alt=""/>
                                 @endforeach
                            ...
                            <!-- /OWL SLIDER -->
                            <!-- article content -->
                            <p class="dropcap">{!! $noticiaActual->contenido !!}</p>
