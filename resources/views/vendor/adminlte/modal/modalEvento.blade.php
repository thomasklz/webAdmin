    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #F6F6F5">
                ...
                <input type="hidden" name="ruta" value="evento/">
                ...
                <div class="form-group">
                    <label class="col-md-2" style="padding-top:7px;">Detalle</label>
                    <div class="col-md-10" style="padding-top:7px;">
                        <input type="text" name="VMdetalle" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2" style="padding-top:7px;">Url</label>
                    <div class="col-md-10" style="padding-top:7px;">
                        <input type="text" name="VMurl" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2" style="padding-top:7px;">Fecha</label>
                  <div class="col-md-10" style="padding-top:7px;">
                  <input size="16" type="text" name="VMfecha" readonly class="form_datetime form-control">
                  </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2" style="padding-top:7px;">Lugar</label>
                    <div class="col-md-10" style="padding-top:7px;">
                        <input type="text" name="VMlugar" class="form-control">
                    </div>
                </div>
            </div>
